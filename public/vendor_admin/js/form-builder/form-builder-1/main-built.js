...
(function (e, t) {
  ...
  function () {
      ...
      (x.debounce = function (e, t, n) {
        ...
        return function () {
          var s = this,
            ...
            a = n && !r;
          return (
            clearTimeout(r), (r = setTimeout(u, t)), a && (i = e.apply(s, o)), i
          );
        };
      }),
      (x.once = function (e) {
    ...
    (x.template = function (e, t, n) {
      ...
      e.replace(i, function (t, n, r, i, u) {
        return (
          (o += e.slice(s, u).replace(B, function (e) {
            return "\\" + H[e];
          })),
  ...
  function () {
    ...
    s.extend(f.prototype, a, {
      ...
      set: function (e, t, n) {
        ...
        for (i in r) {
          ...
          n.unset ? delete a[i] : (a[i] = o),
            !s.isEqual(c[i], o) || s.has(a, i) != s.has(c, i)
              ? ((this.changed[i] = o), n.silent || (this._pending[i] = !0))
              : (delete this.changed[i], delete this._pending[i]);
        }
      ...
      clear: function (e) {
        return (
          ((e || (e = {})).unset = !0), this.set(s.clone(this.attributes), e)
        );
      },
      fetch: function (e) {
        e = e ? s.clone(e) : {};
      ...
      hasChanged: function (e) {
        return arguments.length
          ? s.has(this.changed, e)
          : !s.isEmpty(this.changed);
      },
    ...
    s.extend(l.prototype, a, {
      ...
      add: function (e, t) {
        ...
        for (n = 0, o = e.length; n < o; n++)
          (u = e[n]).on("all", this._onModelEvent, this),
            (this._byCid[u.cid] = u),
            u.id != null && (this._byId[u.id] = u);
        (this.length += o),
          (i = t.at != null ? t.at : this.models.length),
    ...
    s.extend(h.prototype, a, {
        ...
        return (
          ...
          i.history.route(
            ...
            s.bind(function (r) {
              ...
              n && n.apply(this, s),
                this.trigger.apply(this, ["route:" + t].concat(s)),
                i.history.trigger("route", this, t, s);
            }, this)
          ),
          this
        );
      ...
      _routeToRegExp: function (e) {
        return (
          (e = e.replace(v, "\\$&").replace(p, "([^/]+)").replace(d, "(.*?)")),
          new RegExp("^" + e + "$")
        );
      },
    ...
    (m.started = !1),
      s.extend(m.prototype, a, {
        ...
        start: function (e) {
          ...
          r &&
            ((this.iframe = o('<iframe src="javascript:0" tabindex="-1" />')
              .hide()
          ...
          this._wantsPushState &&
            ...
            window.history.replaceState(
              {},
              document.title,
              i.protocol + "//" + i.host + this.options.root + this.fragment
            ));
        ...
        navigate: function (e, t) {
          ...
          this._hasPushState
            ? (n.indexOf(this.options.root) != 0 && (n = this.options.root + n),
              (this.fragment = n),
      ...
      delegateEvents: function (e) {
        ...
        for (var t in e) {
          ...
          (n = s.bind(n, this)),
            ...
            o === "" ? this.$el.bind(i, n) : this.$el.delegate(o, i, n);
        }
      },
    ...
    (i.sync = function (e, t, n) {
      ...
      return (
        n.url || (u.url = C(t, "url") || k()),
        !n.data &&
          t &&
          (e == "create" || e == "update") &&
          ((u.contentType = "application/json"),
          (u.data = JSON.stringify(t.toJSON()))),
        i.emulateJSON &&
        ...
        i.emulateHTTP &&
          ...
          (u.type = "POST"),
          (u.beforeSend = function (e) {
            e.setRequestHeader("X-HTTP-Method-Override", r);
          })),
        u.type !== "GET" && !i.emulateJSON && (u.processData = !1),
        o.ajax(s.extend(u, n))
      );
    }),
  ...
  define("text", ["module"], function (e) {
    ...
    if (
      ...
      c.env === "rhino" ||
      (!c.env && typeof Packages != "undefined" && typeof java != "undefined")
    )
      t.get = function (e, t) {
        var n,
          r,
...
+(function (e) {
    ...
    n.prototype.close = function (t) {
      ...
      i.removeClass("in"),
        e.support.transition && i.hasClass("fade")
          ? i.one(e.support.transition.end, s).emulateTransitionEnd(150)
          : s();
    };
    var r = e.fn.alert;
  ...
  +(function (e) {
    ...
    (t.DEFAULTS = {
      ...
      selector: !1,
      template:
        '<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-menu"></div></div>',
      trigger: "hover focus",
      title: "",
      delay: 0,
      html: !1,
      ...
      (t.prototype.setContent = function () {
        var e = this.tip(),
          t = this.getTitle();
        e.find(".tooltip-menu")[this.options.html ? "html" : "text"](t),
          e.removeClass(
            "fade show bs-popover-top bs-popover-bottom bs-popover-left bs-popover-right"
          );
      }),
      (t.prototype.hide = function () {
        function i() {
  ...
  +(function (e) {
    ...
    (t.DEFAULTS = e.extend({}, e.fn.tooltip.Constructor.DEFAULTS, {
      ...
      content: "",
      template:
        '<div class="popover"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>',
    })),
      ...
      (t.prototype.setContent = function () {
        var e = this.tip(),
          t = this.getTitle(),
          n = this.getContent();
        e.find(".popover-header")[this.options.html ? "html" : "text"](t),
          e.find(".popover-body")[this.options.html ? "html" : "text"](n),
          e.removeClass(
            "fade bs-popover-top bs-popover-bottom bs-popover-left bs-popover-right show"
          ),
          e.find(".popover-header").html() || e.find(".popover-header").hide();
      }),
      (t.prototype.hasContent = function () {
  ...
  +(function (e) {
    ...
    (t.RESET = "affix affix-top affix-bottom"),
      ...
      (t.prototype.checkPosition = function () {
        ...
        var a =
          this.unpin != null && r + this.unpin <= i.top
            ? !1
            : u != null && i.top + this.$element.height() >= n - u
            ? "bottom"
            : o != null && r <= o
            ? "top"
            : !1;
  ...
  define(
    ...
    function (e, t, n, r, i, s, o, u, a, f) {
      return n.View.extend({
        ...
        className: "component",
        initialize: function () {
          (this.template = t.template(f[this.model.idFriendlyTitle()])),
        ...
        render: function (e) {
          ...
          return e
            ? this.$el.html(n.template(n.model.getValues())).attr({
                "data-content": i,
  ...
  define(
    ...
    function (e, t, n, r) {
      return t.extend({
        initialize: function () {
          r.on("newTempPostRender", this.postRender, this),
        ...
        mouseUpHandler: function (e) {
          e.preventDefault(),
            r.trigger("tempDrop", e, this.model),
            this.remove();
        },
      });
    }
      ...
      return n.View.extend({
        ...
        initialize: function () {
          (this.id = this.options.title.toLowerCase().replace(/\W/g, "")),
            (this.tabNavTemplate = t.template(r)),
            this.render();
        },
        render: function () {
          var n = this;
          n.collection !== undefined
      ...
      return n.View.extend({
        ...
        initialize: function () {
          this.collection.on("add", this.render, this),
            ...
            i.on("mySnippetDrag", this.handleSnippetDrag, this),
            i.on("tempMove", this.handleTempMove, this),
            i.on("tempDrop", this.handleTempDrop, this),
            (this.$build = e("#build")),
            (this.build = document.getElementById("build")),
            (this.buildBCR = this.build.getBoundingClientRect()),
            (this.renderForm = t.template(s)),
            this.render();
        },
        render: function () {
          this.$el.empty();
      ...
      return {
        initialize: function () {
          new s({
            ...
            e("#formtabs li").addClass("nav-item"),
            e("#formtabs li a")
              .addClass("nav-link m-r-5")
              .first()
              .addClass("active"),
            new o({
              title: "Original",
